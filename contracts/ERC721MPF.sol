...
contract ERC721MPF is Context, ERC165, IERC721MP {
    ...
    /**
     * @dev Returns The Next TokenID To Be Minted For projectID
     */
    function ReadNextTokenID(uint projectID) public view returns (uint) { return (projectID * ONE_MILLION) + _ProjectInvocations[projectID]; }
