...
contract DraftPicker is Ownable, ReentrancyGuard
{
    struct DraftPick
    {
        ...
        bool _DraftPickActive;     // [18] -> _DraftPickActive (If True, Claims Are Available)
    }
    ...
    address public _BRT_MULTISIG = 0x0BC56e3c1397e4570069e89C07936A5c6020e3BE;
    address public _ART_BLOCKS = 0x43A7D26a271F5801b8092d94DFd5b36EA5D01F5f;
    ...
    constructor()
    {
        _DraftPicks[0] = DraftPick( 
            ...
            67,                                         // Max Total Claim
            16,                                         // Available Directs
            51,                                         // Available MintPass
    ...
    function PurchaseTokensDirect(
        ...
        require(_DraftPicks[DraftIndex]._DraftPickActive, "DraftPicker: Draft Pick Is Not Active");
    ...
    /**
     * @dev Changes The Active State Of The Draft Pick
     */
    function _ChangeActiveState(uint DraftIndex, bool ActiveState) external onlyAdmin { _DraftPicks[DraftIndex]._DraftPickActive = ActiveState; }

    /**
     * @dev Withdraws All ETH To Multisig
     */
    function _WithdrawETHToMultisig() external onlyAdmin 
    { 
    ...
    /**
     * @dev Changes The BrightMoments Split Address
     */
    function ____ChangeSplitAddressBrightMoments(address NewAddress) external onlyOwner { _BRT_MULTISIG = NewAddress; }

    /**
     * @dev Changes The ArtBlocks Address
     */
    function ____ChangeSplitAddressArtBlocks(address NewAddress) external onlyOwner { _ART_BLOCKS = NewAddress; }
    ...
    function __FinalizeDraftPickSale(uint DraftIndex, uint MessageValue) internal
    {
        if(MessageValue > 0)
        {
            ...
            (bool Tx1,) = _BRT_MULTISIG.call { value: BrightMomentsSplit }("");
            (bool Tx2,) = _ART_BLOCKS.call { value: ArtBlocksSplit }("");
            (bool Tx3,) = _DraftPicks[DraftIndex]._ArtistAddress.call { value: ArtistAmount }("");
            require(Tx1 && Tx2 && Tx3, "DraftPicker: ETH Transfers Failed");
        }
    }
