...
{  
    ...
    address private constant _GOLDEN_TOKEN = 0x40B075708419E26bC52A9dd2ac99A08a4ECAbC2F;   // GOERLI
    address private constant _CITIZEN_MINTER = 0xd8a90CbD15381fc0226Be61AC522fee97f6C2Ed9; // GOERLI
    ...
    uint public _CCI = 7;                                                                  // Current City Index
    ...
    { 
        ...
        Role[msg.sender] = _MINTER_ROLE; // GOERLI
     ...
     */
    function __InitLiveMintArtist(Artist memory _Params) external onlyAdmin returns (uint ArtistID)
    {
    ...
    function readCitizenUnmintedTicketIDs() public view returns(uint[] memory)
    {
        ...
        for(uint TokenID; TokenID < 1000; TokenID++)
        {
            ...
            (
                ...
                ||
                (!_MintedCitizen[_CCI][_TokenID] && _TokenID < 666)
            ) 
            { 
