...
contract MPMM is Ownable, ERC721AO, DefaultOperatorFilterer, MarketplaceEnabled
{
    uint public _CurrentSeedIndex;
    uint public _ArtBlocksProjectID = 39;
    string public baseURI = "ipfs://QmPj65uqf7UTvYfehHJd2wGKhDhP2KNUzr9VvCydLUxmLZ/";
    address public _LIVE_MINT = 0x1668f841ed817f5622a8480136B8c9CA1Fd09E6c;
    bytes4 private constant _INTERFACE_ID_ERC2981 = 0x2a55205a;

    constructor() ERC721AO("Mint Pass Metabolic Metropolis | A.A. Murakami x Bright Moments | MPMM", "MPMM") 
    { 
        _mint(msg.sender, 100);
        _mint(0xB96E81f80b3AEEf65CB6d0E280b15FD5DBE71937, 100);
