...
contract PledgeLeaderboard is Ownable
{
    struct Bid
    {
    ...
    { 
        ...
        SaleState[0]._LastMinBid = 0.00004 ether; // starts auction specified ETH value
        ...
        AuctionParams[0]._InitialMinimumBid = 0.00004 ether; // sets initial minimum bid
    ...
    function Pledge (uint SaleIndex) external payable
    {
        ...
        Bids[SaleIndex][CurrentBidIndex] = Bid (
            ...
            0,        // [1] -> Priority Of Bid (Merkle Rank)
            0,       // [2] -> Allocation For Provided Priority Tier
    ...
    function IncreaseBid ( uint SaleIndex, uint[] calldata BidIndexes, uint[] calldata Amounts ) external payable
    {
     ...
     */
    function __WithdrawETHToMultisig() external onlyOwner
    {
