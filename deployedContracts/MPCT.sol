...
contract MPCT is Ownable, ERC721AO, DefaultOperatorFilterer, IOS, MarketplaceEnabled
{
    uint public _CurrentSeedIndex;
    uint public _ArtBlocksProjectID = 39;
    string public baseURI = "ipfs://QmaeYCnyhS3aAwLiMBHjyLq4kgdnWXet1N5ChKXqLFacZY/";
    address public _LIVE_MINT = 0x1668f841ed817f5622a8480136B8c9CA1Fd09E6c;

    constructor() ERC721AO("Mint Pass Cantera | Jacek Markusiewicz x Bright Moments | MPCT", "MPCT") 
    { 
        _mint(msg.sender, 95);
     ...
     */
    function __ChangeMarketplaceAddress(address NewAddress) override virtual external onlyOwner { _ADDRESS_MARKETPLACE = NewAddress; }
