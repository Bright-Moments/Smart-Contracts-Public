...
contract MPAG is Ownable, ERC721AO, DefaultOperatorFilterer, MarketplaceEnabled
{
    uint public _CurrentSeedIndex;
    uint public _ArtBlocksProjectID = 39;
    string public baseURI = "ipfs://QmbPSiFdvptNGErx9x3hmug8TjpR2bwppqcwKYSfvUHVZq/";
    address public _LIVE_MINT = 0x1668f841ed817f5622a8480136B8c9CA1Fd09E6c;

    constructor() ERC721AO("Mint Pass Agar | Emily Edelman x Bright Moments | MPAG", "MPAG") 
    { 
    ...
    {
        require(totalSupply() + Amount <= 1000, "MP: Max Supply Reached");
