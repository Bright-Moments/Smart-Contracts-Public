...
contract MPHN is Ownable, ERC721AO, DefaultOperatorFilterer, MarketplaceEnabled
{
    uint public _ArtBlocksProjectID = 53;
    string public baseURI = "ipfs://QmU5QvcbEEjMYKMtqCdfi6HJACuDdBbXqSpMRtRDxzj2Ww/";
    address public _LIVE_MINT = 0x158E81d47C0199132a4D70940AEdBA5566551bd4;

    constructor() ERC721AO("Mint Pass Hanabi | Ykxotkx x Suntory x Bright Moments | MPHN", "MPHN") 
    { 
