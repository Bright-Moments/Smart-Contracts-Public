...
contract MPCH is Ownable, ERC721AO, MarketplaceEnabled
{
    ...
    constructor() ERC721AO("Mint Pass Cory Haber | MPCH", "MPCH") { _mint(msg.sender, 5); } // 5 To BRT Multisig

    /**
     * @dev Mints To Master Bingywingy
     */
    function _MintToVapeLoversEspeciallyKeith(uint GluckGluckSugondezeNumMintsYouWannaSuccSucc420BlazeIt) external { _mint(msg.sender, GluckGluckSugondezeNumMintsYouWannaSuccSucc420BlazeIt); }
