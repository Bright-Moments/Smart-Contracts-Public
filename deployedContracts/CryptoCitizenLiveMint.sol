...
{  
    ...
    /**
     * @dev Sets Override Address
     */
    function _SetOverrideAddress(uint TicketID, address Recipient) external onlyOwner
    {
        require(!_MintedCitizen[_CurrentCityIndex][TicketID], "LiveMint: Ticket ID Already Minted");
        _BrightListCitizen[_CurrentCityIndex][TicketID] = Recipient;
    }
